...
# --> armhf
SRC_URI:armv7a = "https://dl.influxdata.com/influxdb/releases/influxdb-${PV}_linux:armhf.tar.gz;\
sha256sum=bf77801cc85a9e9f1710f38dc1263b5202e4d8f83c56a53501b033d6ade384a3 \
file://LICENSE"

SRC_URI_einstein = "https://dl.influxdata.com/influxdb/releases/influxdb-${PV}_linux:armhf.tar.gz;\
sha256sum=bf77801cc85a9e9f1710f38dc1263b5202e4d8f83c56a53501b033d6ade384a3 \
file://LICENSE"
# <-- armhf
